          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center group cursor-pointer select-none">
                <input
                  type="checkbox"
                  className="h-4 w-4 text-purple-600 focus:ring-purple-500/50 border-slate-600 rounded bg-slate-800/50 transition-colors duration-200"
                />
                <span className="ml-3 text-sm text-slate-400 group-hover:text-slate-300 transition-colors duration-200 select-none">Remember me</span>
              </label>
            </div>

            <Link
              href="/home"
              className="w-full flex justify-center py-4 px-6 border border-transparent rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800 hover:from-purple-700 hover:via-purple-800 hover:to-purple-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500/50 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
            >
              Sign in
            </Link>
          </form>
