...
export default function EditBudgetPage() {
    ...
    try {
      ...
      if (foundBudget) {
        ...
        setFormData({
          ...
          monthlyBudget: foundBudget.monthlyBudget,
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black flex items-center justify-center">
        <div className="text-white text-xl select-none">Loading budget...</div>
      </div>
    );
  }
  ...
  if (!budget) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black flex items-center justify-center">
        <div className="text-white text-xl select-none">Budget not found</div>
      </div>
    );
  }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
                {['family', 'work', 'leisure', 'housing', 'health', 'savings'].map((icon) => (
                  <button
                    key={icon}
                    type="button"
                  ...
                  >
                    <div className="flex justify-center">
                      <div className="text-white" style={{ color: formData.color }}>
                        {renderIcon(icon)}
                      </div>
                    </div>
